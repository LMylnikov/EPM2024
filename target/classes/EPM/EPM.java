...
////import com.mycompany.EPM.groupJDBC.artifactJDBC.*;
...
public class EPM extends javax.swing.JFrame {     
    private static final int FRAME_OFFSET = 20;
    private int c=0; // номер нового создаваемого EPM для вычисления смещения
...
// /*
    ...
    private void SaveasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveasActionPerformed
        ...
        try {
            ...
            Logger.getLogger(EPM.class.getName()).log(Level.SEVERE, null, ex);
